...
\begin{enumerate}[leftmargin=*,itemsep=0.2\baselineskip,topsep=2pt,parsep=0pt,partopsep=0pt]
  ...
  \textbf{Comprobación realizada.} Se compararon pesos, informes de test y métricas por sesión, usando \texttt{SuperCarModel} como referencia del modelo evaluado en modo test y reservando \texttt{SessionCarModel} para el contexto de entrenamiento o sesión.
