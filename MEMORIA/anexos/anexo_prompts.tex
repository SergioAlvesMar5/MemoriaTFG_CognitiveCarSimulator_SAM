...
\newcommand{\promptDepurado}{\Needspace{11\baselineskip}\textbf{Prompt depurado.}}

{\small
\begin{enumerate}[leftmargin=*,itemsep=0.35\baselineskip,topsep=4pt,parsep=0pt,partopsep=0pt]
  ...
  \textbf{Uso final en el proyecto.} El capítulo 5 describe la penalización por marcha atrás, estancamiento y navegación no válida, y el capítulo 6 advierte que el tiempo de vida no puede usarse como único indicador.
  ...
  \textbf{Uso final en el proyecto.} El capítulo 6 se apoya en métricas calculadas a partir de estos CSV y conserva explícitamente incidencias de cobertura o duplicados.
  ...
  \textbf{Uso final en el proyecto.} El capítulo 5 explica la persistencia de modelos y el capítulo 6 evita sustituir la referencia por sesiones posteriores no reproducibles.
  ...
  \textbf{Uso final en el proyecto.} Los capítulos 5 y 6 describen las rotondas como subsistema propio, con penalización de aceleración, completaciones confirmadas y limitaciones de escala.
  ...
  \textbf{Comprobación realizada.} Se contrastaron los bloques del 18, 22, 23, 26 y 29 de junio, con especial atención a \texttt{STOP\_VIOLATION} y a la variabilidad entre sesiones.
  ...
  \textbf{Objetivo.} Mantener el proyecto reproducible pese a trabajar con Unreal Engine, Blueprints, binarios, logs extensos y resultados experimentales pesados.

  \promptDepurado
  \begin{quote}
  \small
  Ayúdame a organizar el repositorio y el flujo de trabajo para un proyecto de Unreal Engine con Blueprints, modelos guardados, logs, CSV de entrenamiento y memoria en LaTeX. Distingue qué archivos deben versionarse, cuáles son temporales, cuáles deben archivarse como evidencia experimental y cómo nombrar carpetas para reconstruir una sesión. Propón además un script o procedimiento para limpiar logs irrelevantes conservando warnings, mensajes propios de Blueprints y datos útiles de depuración.
  \end{quote}
