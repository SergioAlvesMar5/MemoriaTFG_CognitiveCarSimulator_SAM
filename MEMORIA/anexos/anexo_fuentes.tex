...
\Needspace{8\baselineskip}
También se analizaron los entrenamientos de los días 11, 16, 17, 18, 22, 23, 25, 26, 29 y 30 de junio, además de los entrenamientos del 1 y 2 de julio. Los bloques posteriores al día 18 no sustituyen a la referencia estable porque muestran regresiones normativas, entrenamientos incompletos o resultados demasiado variables entre sesiones. Se conservan para documentar el efecto de los cambios de fitness, stop, ceda, rotondas, diagnóstico de solapes y bloqueo en cruce. La sesión del 3 de julio se trató aparte como \texttt{FreeRun}, ya que exporta eventos terminales y coches vivos censurados en lugar de generaciones cerradas. La figura del capítulo 7 se ha regenerado en PDF vectorial a partir del \texttt{Training\_Summary.csv} del día 18, y tanto los datos como el código PGFPlots quedan archivados en \texttt{MEMORIA/assets}.
