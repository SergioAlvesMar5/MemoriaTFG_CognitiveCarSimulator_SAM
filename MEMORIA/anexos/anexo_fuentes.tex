...
Los resultados documentados proceden de \path{INFO/ANALISIS_DATOS/Analisis}. La referencia histórica del 18 de junio combina el entrenamiento \path{train_2026-06-18_11-21}, con 548 generaciones y 16432 registros de vehículos, y cuatro carpetas de test que suman 21 ejecuciones y 1134 registros sobre 54 spawns. Esa agrupación describe una misma etapa experimental; los tests cargan \texttt{SuperCarModel} consolidados los días 16--17 de junio y no se presentan como validación directa de una genealogía entrenamiento-modelo concreta. La marca horaria forma parte del identificador y no se utiliza como variable experimental.
