...
Las ejecuciones posteriores del 22 y 23 de junio refuerzan esa cautela. Después de modificar la escala del fitness y el límite temporal del stop, el entrenamiento del día 22 eleva los fallos legales al 58.17\%, casi siempre por \texttt{STOP\_VIOLATION}. Los tests de ese mismo día aún conservan un 52.91\% de acierto, pero los del día 23 caen al 16.27\% y muestran un 48.99\% de fallos legales. Esta secuencia se interpreta como una regresión detectada y no como nueva referencia. El resultado muestra el valor práctico de conservar configuraciones y de contrastar cada cambio con más de una métrica.
