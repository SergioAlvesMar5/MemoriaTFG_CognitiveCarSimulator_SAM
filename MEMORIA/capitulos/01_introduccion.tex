...
La evaluación principal utiliza el entrenamiento del 18 de junio de 2026 y cuatro sesiones de test posteriores sobre 54 puntos de aparición. Ese bloque obtiene una tasa de acierto operativo del 57.50\%, con 652 aciertos sobre 1134 evaluaciones según el criterio de test definido en el capítulo de resultados. La serie posterior, desde finales de junio hasta el 7 de julio, se conserva como diagnóstico y validación posterior: algunas pruebas mantienen parte del comportamiento aprendido, otras revelan regresiones de señalización, las sesiones \texttt{FreeRun} amplían la observación de cedas, stops, solapes, colas de liberación, bloqueo en cruces y navegación fuera de zona, y el bloque final comprueba la versión instrumentada del programa. Esta separación evita presentar la fecha más reciente como la mejor por defecto y permite distinguir una referencia estable de una iteración exploratoria o posterior.
