...
El desarrollo no siguió una línea directa desde la primera implementación hasta el resultado final. En las fases iniciales se probaron enfoques deterministas de navegación, como rutas y \textit{Path Finding}, que sirvieron para entender el mapa pero produjeron comportamientos rígidos en un vehículo físico. Después se construyó una línea de pruebas reducida para aprender centrado, avance y giros básicos. Más adelante se introdujeron puntos de aparición distribuidos por la ciudad, separación entre entrenamiento y test, señales de tráfico, intersecciones, rotondas, persistencia de modelos y análisis sistemático de CSV. La última fase añadió además interacción física entre coches, detección de solapes, distancia de seguridad y un modo de simulación libre.
