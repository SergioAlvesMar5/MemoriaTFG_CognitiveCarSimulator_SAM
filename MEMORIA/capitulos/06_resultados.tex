...
Los bloques posteriores del 22 y 23 de junio se emplean como pruebas de regresión, no como nueva referencia principal. El primero conserva un rendimiento próximo al del día 18, aunque con más fallo legal. El segundo muestra una degradación clara por \texttt{STOP\_VIOLATION}. Por ello, los resultados principales del capítulo se apoyan en la configuración validada del 18 de junio y las sesiones posteriores se interpretan como evidencia para decidir las siguientes correcciones.
...
Los bloques del 22 y 23 muestran por qué no basta con seguir la fecha más reciente. El día 22 mantiene un 52.91\% de acierto y una vida media de 76.20 segundos, todavía cerca de la referencia. El día 23 cae al 16.27\% de acierto y concentra casi la mitad de sus fallos en causas legales. Ese contraste convierte las sesiones posteriores en material de diagnóstico, no en sustitución directa del bloque del día 18.
...
\section{Pruebas posteriores del 22 y 23 de junio}
...
La comparación no aísla por sí sola cuál de las modificaciones provoca el resultado, pero sí demuestra que la referencia del día 18 no debe reemplazarse. La siguiente iteración debe revisar el límite temporal del stop, repetir una prueba corta modificando un único componente y mantener constantes modelo, spawns y criterios de test antes de lanzar un entrenamiento largo.
