...
7 de julio, bloque largo & Validación posterior final & Evalúa el \texttt{SuperCarModel} del 5 de julio a las 18:30:36 con la versión final instrumentada, 59 spawns y 2950 evaluaciones declaradas. & Usa una configuración más rica que la referencia y no debe mezclarse con tests de otros \texttt{SuperCarModel}.\\
...
1-jul & Persisten cambios de stop, ceda y navegación con varios bloques pequeños. & \shortstack[l]{\texttt{STOP\_VIOLATION}\\\texttt{\_TIMEOUT}}, ceda, navegación y colisiones. & 27.38\%. & Diagnóstico de fallos introducidos o visibilizados por reglas más estrictas.\\
2-jul & Recuperación parcial tras ajustes de señalización. & Causas terminales comunes y \shortstack[l]{\texttt{STOP\_VIOLATION}\\\texttt{\_EXIT}}. & 193/354, 54.52\%. & Mejora respecto al 1 de julio, pero bloque único y menor que la referencia histórica.\\
...
7-jul largo & Versión final instrumentada; \texttt{SuperCarModel} del 5 de julio a las 18:30:36; 59 spawns. & \texttt{STOP\_TIMEOUT}, ceda, \texttt{NAV}, solapes, bloqueo y triggers. & 2497/2950, 84.64\%. & Validación posterior final; no agregable directamente al 18 de junio por protocolo, modelo e instrumentación.\\
...
7-jul final, bloque largo & 2950 & 59 & 2497 & 84.64\% & 83.30--85.90\% & Validación posterior del \texttt{SuperCarModel} del 5 de julio a las 18:30:36; reduce colisiones, separa el timeout de stop y mide solapes y bloqueo en cruce.\\
