...
El alcance también comprende la interacción con semáforos, stops y cedas, incluida la detección de líneas de parada y la validación de las maniobras. Se han separado los puntos de aparición utilizados para entrenar de los reservados para test y se exportan métricas individuales y resúmenes a CSV. Esta instrumentación permite comparar sesiones y localizar intersecciones o puntos del mapa donde el modelo falla de forma repetida.
