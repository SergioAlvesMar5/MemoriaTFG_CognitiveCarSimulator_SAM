...
Junio & Separación train/test, rotondas y análisis de regresión. & Se diferenciaron spawns y trayectorias por modo, se añadieron métricas de rotonda y se compararon bloques repetidos. Las sesiones del 22 y 23 de junio muestran que una mejora local del fitness puede degradar stops o generalización.\\
\end{longtable}
}
