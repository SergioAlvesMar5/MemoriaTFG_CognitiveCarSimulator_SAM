...
\caption{Principales hitos y decisiones documentadas en reuniones. Fuente: elaboración propia a partir de las actas de seguimiento.}\label{tab:cronologia}\\
\toprule
...
\caption{Riesgos principales del proyecto. Fuente: elaboración propia.}\label{tab:riesgos}\\
\toprule
