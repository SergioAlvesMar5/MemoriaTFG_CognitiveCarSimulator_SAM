...
\endhead
\bottomrule
\multicolumn{3}{c}{\textit{Fuente. Elaboración propia a partir de las actas de seguimiento.}}\\
\endfoot
\bottomrule
\multicolumn{3}{c}{\textit{Fuente. Elaboración propia a partir de las actas de seguimiento.}}\\
\endlastfoot
...
\endhead
\bottomrule
\multicolumn{4}{c}{\textit{Fuente. Elaboración propia a partir del seguimiento técnico del proyecto.}}\\
\endfoot
\bottomrule
\multicolumn{4}{c}{\textit{Fuente. Elaboración propia a partir del seguimiento técnico del proyecto.}}\\
\endlastfoot
