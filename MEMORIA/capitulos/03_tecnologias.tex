...
Python & Sin versión fijada en repositorio & Scripts de análisis y limpieza en \texttt{INFO/ANALISIS\_DATOS}; sin \texttt{requirements.txt}.\\
NumPy & Sin versión fijada en repositorio & Importado por los scripts de análisis.\\
Matplotlib & Sin versión fijada en repositorio & Generación de gráficas exportadas desde CSV.\\
Seaborn & Dependencia opcional & Visualizaciones complementarias si está disponible; el análisis básico no depende de él.\\
pandas & No consta como dependencia directa & No aparece importado en los scripts revisados.\\
Git/GitLab & Sin versión de servidor documentada & Uso acreditado por issues, milestones y trazabilidad de tareas.\\
